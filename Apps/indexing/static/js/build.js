...
!function webpackUniversalModuleDefinition(e, t) {
    ...
    return (() => {
        ...
        var __webpack_modules__ = [, (e, t, r) => {
            ...
            t.addLinkAttributes = function addLinkAttributes(e, {url: t, target: r, rel: a, enabled: o = !0} = {}) {
            ...
            t.bytesToString = function bytesToString(e) {
                ...
                const n = [];
                for (let s = 0; s < t; s += r) {
                    const a = Math.min(s + r, t), i = e.subarray(s, a);
            ...
            t.createObjectURL = function createObjectURL(e, t = "", r = !1) {
                ...
                for (let t = 0, r = e.length; t < r; t += 3) {
                    const a = 255 & e[t], i = 255 & e[t + 1], o = 255 & e[t + 2];
            ...
            class Util {
                ...
                static getAxialAlignedBoundingBox(e, t) {
                    const r = Util.applyTransform(e, t), n = Util.applyTransform(e.slice(2, 4), t),
                        s = Util.applyTransform([e[0], e[3]], t), a = Util.applyTransform([e[2], e[1]], t);
                ...
                static singularValueDecompose2dScale(e) {
                    const t = [e[0], e[2], e[1], e[3]], r = e[0] * t[0] + e[1] * t[2], n = e[0] * t[1] + e[1] * t[3],
                        s = e[2] * t[0] + e[3] * t[2], a = e[2] * t[1] + e[3] * t[3], i = (r + a) / 2,
                        o = Math.sqrt((r + a) ** 2 - 4 * (r * a - s * n)) / 2, l = i + o || 1, c = i - o || 1;
            ...
            var _util = __w_pdfjs_require__(2), _display_utils = __w_pdfjs_require__(1),
                ...
                _metadata = __w_pdfjs_require__(14), _optional_content_config = __w_pdfjs_require__(15),
                _transport_stream = __w_pdfjs_require__(16), _webgl = __w_pdfjs_require__(17);
            ...
            function getDocument(e) {
                ...
                let r;
                if ("string" == typeof e || e instanceof URL) r = {url: e}; else if ((0, _util.isArrayBuffer)(e)) r = {data: e}; else if (e instanceof PDFDataRangeTransport) r = {range: e}; else {
                ...
                for (const e in r) {
                    ...
                    switch (e) {
                        ...
                        case"worker":
                            ...
                            continue;
                        case"data":
                            if (_is_node.isNodeJS && "undefined" != typeof Buffer && t instanceof Buffer) n[e] = new Uint8Array(t); else {
                ...
                a.promise.then((function () {
                    ...
                    const e = _fetchDocument(a, n, s, i), r = new Promise((function (e) {
                        let t;
            ...
            class PDFPageProxy {
                ...
                render({
                    ...
                    const f = o || new DefaultCanvasFactory({ownerDocument: this._ownerDocument}),
                        g = new _webgl.WebGLContext({enable: n});
                    ...
                    Promise.all([p.displayReadyCapability.promise, h]).then((([e, t]) => {
                        if (this.pendingCleanup) complete(); else {
                            ...
                            m.initializeGraphics({transparency: e, optionalContentConfig: t});
                ...
                _tryCleanup(e = !1) {
                    ...
                    for (const {
                        renderTasks: e,
                        operatorList: t
                    } of this._intentStates.values()) if (e.size > 0 || !t.lastChunk) return !1;
                    ...
                    const r = new WeakMap, n = {
                        data: function cloneValue(e) {
                            ...
                            for (const t in e) {
                                ...
                                if (void 0 !== r.value) if ("function" != typeof r.value) s[t] = cloneValue(r.value); else if (e.hasOwnProperty?.(t)) throw new Error(`LoopbackPort.postMessage - cannot clone: ${e[t]}`)
                            }
                            return s
                        }(e)
                    };
                    ...
                    e.on("commonobj", (t => {
                        ...
                        if (!this.commonObjs.has(r)) switch (n) {
                            case"Font":
                                ...
                                this.fontLoader.bind(i).catch((t => e.sendWithPromise("FontFallback", {id: r}))).finally((() => {
                ...
                if (!e.mozCurrentTransform) {
                    ...
                    Object.defineProperty(e, "mozCurrentTransformInverse", {
                        get: function getCurrentTransformInverse() {
                            const e = this._transformMatrix, t = e[0], r = e[1], n = e[2], s = e[3], a = e[4], i = e[5],
                                o = t * s - r * n, l = r * n - t * s;
            ...
            const l = function CanvasExtraStateClosure() {
                ...
                function putBinaryImageData(e, t, r = null) {
                    ...
                    const s = t.height, a = t.width, o = s % i, l = (s - o) / i, c = 0 === o ? l : l + 1,
                ...
                function putBinaryImageMask(e, t) {
                    const r = t.height, n = t.width, s = r % i, a = (r - s) / i, o = 0 === s ? a : a + 1,
                ...
                CanvasGraphics.prototype = {
                    beginDrawing({transform: e, viewport: t, transparency: r = !1, background: n = null}) {
                        const s = this.ctx.canvas.width, a = this.ctx.canvas.height;
                        this.ctx.save();
                        ...
                        const a = e.argsArray, i = e.fnArray;
                        let o = t || 0;
                        const l = a.length;
                        if (l === o) return o;
                        ...
                        for (; ;) {
                            ...
                            f = i[o];
                            if (f !== n.OPS.dependency) this[f].apply(this, a[o]); else for (const e of a[o]) {
                        ...
                        const e = this.current.activeSMask, t = e.canvas.width, r = e.canvas.height,
                            ...
                            a = this.ctx, i = a.mozCurrentTransform;
                        this.ctx.save();
                        const o = s.context;
                        ...
                        if (this.contentVisible) if ("object" == typeof r && r?.getPattern) {
                            ...
                            const a = this.getSinglePixelWidth(), i = this.current.lineWidth * s;
                            if (a < 0 && -a >= i) {
                                t.resetTransform();
                        ...
                        const o = r.italic ? "italic" : "normal", l = `"${a}", ${r.fallbackName}`;
                        let c = t;
                        ...
                        const i = this.ctx, o = this.current, l = o.font, c = o.textRenderingMode,
                        ...
                        if (l.disableFontFace || p) {
                            ...
                            if (d === n.TextRenderingMode.STROKE || d === n.TextRenderingMode.FILL_STROKE) if (a) {
                                i.save();
                                i.moveTo(t, r);
                                i.resetTransform();
                                i.lineWidth = Math.round(this._combinedScaleFactor);
                        ...
                        const s = t.fontSize;
                        if (0 === s) return;
                        const a = this.ctx, i = t.fontSizeScale, o = t.charSpacing, l = t.wordSpacing,
                        ...
                        for (S = 0; S < d; ++S) {
                            ...
                            let v, x, P, k = t.width;
                            if (u) {
                                const e = t.vmetric || f, r = -(t.vmetric ? e[1] : .5 * k) * g, n = e[2] * g;
                                k = e ? -e[0] : k;
                                v = r / i;
                                x = (C + n) / i
                            } else {
                            ...
                            if (this.contentVisible && (t.isInFont || r.missingFile)) if (m && !y) a.fillText(A, v, x); else {
                                this.paintChar(A, v, x, _, b);
                                if (y) {
                                    const e = v + s * y.offset.x / i, t = x - s * y.offset.y / i;
                        ...
                        const t = this.ctx, r = this.current, s = r.font, a = r.fontSize, i = r.fontDirection,
                            o = s.vertical ? 1 : -1, l = r.charSpacing, c = r.wordSpacing, h = r.textHScale * i,
                        ...
                        if (!(r.textRenderingMode === n.TextRenderingMode.INVISIBLE) && 0 !== a) {
                            ...
                            for (p = 0; p < u; ++p) {
                                ...
                                const i = (f.isSpace ? c : 0) + l, u = s.charProcOperatorList[f.operatorListId];
                                if (!u) {
                        ...
                        if (a) {
                            const e = t.canvas, r = e.width, s = e.height, i = n.Util.applyTransform([0, 0], a),
                                o = n.Util.applyTransform([0, s], a), l = n.Util.applyTransform([r, 0], a),
                                c = n.Util.applyTransform([r, s], a), h = Math.min(i[0], o[0], l[0], c[0]),
                                d = Math.min(i[1], o[1], l[1], c[1]), u = Math.max(i[0], o[0], l[0], c[0]),
                        ...
                        const t = this.ctx, r = e.width, n = e.height, s = this.current.fillColor,
                            a = this.current.patternFill, i = this.processingType3;
                        ...
                        if (!this.contentVisible) return;
                        const i = e.width, o = e.height, l = this.current.fillColor, c = this.current.patternFill,
                            h = this.cachedCanvases.getCanvas("maskCanvas", i, o), d = h.context;
                        d.save();
                        ...
                        for (let s = 0, a = e.length; s < a; s++) {
                            const a = e[s], i = a.width, o = a.height,
                                l = this.cachedCanvases.getCanvas("maskCanvas", i, o), c = l.context;
                            c.save();
                        ...
                        let a, i, o, l = Math.max(Math.hypot(s[0], s[1]), 1), c = Math.max(Math.hypot(s[2], s[3]), 1);
            ...
            s.RadialAxial = {
                fromIR: function RadialAxial_fromIR(e) {
                    const t = e[1], r = e[2], n = e[3], s = e[4], a = e[5], i = e[6], o = e[7];
                    return {
            ...
            const a = function createMeshCanvasClosure() {
                function drawTriangle(e, t, r, n, s, a, i, o) {
                    ...
                    const p = (l[r] + t.offsetX) * t.scaleX, f = (l[r + 1] + t.offsetY) * t.scaleY,
                        ...
                        _ = (l[s] + t.offsetX) * t.scaleX, A = (l[s + 1] + t.offsetY) * t.scaleY;
                    if (f >= A) return;
                    const b = c[a], y = c[a + 1], S = c[a + 2], C = c[i], v = c[i + 1], x = c[i + 2], P = c[o],
                        k = c[o + 1], R = c[o + 2], w = Math.round(f), T = Math.round(A);
                    let E, F, M, L, D, I, O, N;
                    for (let e = w; e <= T; e++) {
                        if (e < m) {
                            let t;
                ...
                return function createMeshCanvas(e, t, r, n, s, a, i, o) {
                    const l = Math.floor(e[0]), c = Math.floor(e[1]), h = Math.ceil(e[2]) - l, d = Math.ceil(e[3]) - c,
                        ...
                        m = {coords: r, colors: n, offsetX: -l, offsetY: -c, scaleX: 1 / f, scaleY: 1 / g}, _ = u + 4,
                        A = p + 4;
                    let b, y, S, C;
                    if (o.isEnabled) {
                        b = o.drawFigures({width: u, height: p, backgroundColor: a, figures: s, context: m});
            ...
            s.Mesh = {
                fromIR: function Mesh_fromIR(e) {
                    const t = e[2], r = e[3], s = e[4], i = e[5], o = e[6], l = e[7], c = e[8];
                    return {
            ...
            const i = function TilingPatternClosure() {
                ...
                TilingPattern.prototype = {
                    createPatternCanvas: function TilinPattern_createPatternCanvas(e) {
                        const t = this.operatorList, r = this.bbox, s = this.xstep, a = this.ystep, i = this.paintType,
                        ...
                        const h = r[0], d = r[1], u = r[2], p = r[3],
                            ...
                            m = [f[0] * g[0], f[1] * g[1]], _ = this.getSizeAndScale(s, this.ctx.canvas.width, m[0]),
                            A = this.getSizeAndScale(a, this.ctx.canvas.height, m[1]),
                            b = e.cachedCanvases.getCanvas("pattern", _.size, A.size, !0), y = b.context,
            ...
            var n = r(2);
            const s = 1, a = 2, i = 1, o = 2, l = 3, c = 4, h = 5, d = 6, u = 7, p = 8;
            ...
            t.MessageHandler = class MessageHandler {
                constructor(e, t, r) {
                    ...
                    this._onComObjOnMessage = e => {
                        ...
                        if (t.callbackId) {
                            const e = this.sourceName, i = t.sourceName;
                ...
                sendWithPromise(e, t, r) {
                    const s = this.callbackId++, a = (0, n.createPromiseCapability)();
                ...
                sendWithStream(e, t, r, s) {
                    const a = this.streamId++, o = this.sourceName, l = this.targetName, c = this.comObj;
                ...
                _createStreamSink(e) {
                    const t = this, r = this.actionHandler[e.action], s = e.streamId, a = this.sourceName,
                        i = e.sourceName, o = this.comObj, d = {
                            enqueue(e, r = 1, o) {
                ...
                _processStreamMessage(e) {
                    const t = e.streamId, r = this.sourceName, s = e.sourceName, a = this.comObj;
                    switch (e.stream) {
                        case p:
                ...
                return {
                    tryInitGL() {
                        ...
                        r || function initSmaskGL() {
                            ...
                            const o = s.getAttribLocation(a, "a_texCoord"), l = s.getUniformLocation(a, "u_image"),
                                c = s.getUniformLocation(a, "u_mask"), h = s.createBuffer();
                        ...
                        for (let e = 0, t = i.length; e < t; e++) {
                            const t = i[e], r = t.coords, n = t.colors;
                            switch (t.type) {
                                case"lattice":
            ...
            class AnnotationElement {
                ...
                _createContainer(e = !1) {
                    const t = this.data, r = this.page, n = this.viewport, a = document.createElement("section");
                    let i = t.rect[2] - t.rect[0], o = t.rect[3] - t.rect[1];
            ...
            class WidgetAnnotationElement extends AnnotationElement {
                ...
                _setColor(e) {
                    const {detail: t, target: r} = e, {style: n} = r;
            ...
            class TextWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    ...
                    if (this.renderInteractiveForms) {
                        const n = e.getValue(t, {value: this.data.fieldValue, valueAsString: this.data.fieldValue}),
                            s = n.valueAsString || n.value || "", a = {
                                userValue: null,
                                formattedValue: null,
                ...
                _setTextStyle(e) {
                    const t = ["left", "center", "right"], {
                        fontSize: r,
                        fontColor: n
                    } = this.data.defaultAppearanceData, a = e.style;
                    r && (a.fontSize = `${r}px`);
            ...
            class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    const e = this.annotationStorage, t = this.data, r = t.id,
                        n = e.getValue(r, {value: t.fieldValue && (t.exportValue && t.exportValue === t.fieldValue || !t.exportValue && "Off" !== t.fieldValue)}).value;
            ...
            class RadioButtonWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    ...
                    const e = this.annotationStorage, t = this.data, r = t.id,
                        n = e.getValue(r, {value: t.fieldValue === t.buttonValue}).value,
            ...
            class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    ...
                    const getValue = (e, t) => {
                        const r = t ? "value" : "textContent", n = e.target.options;
                    ...
                    if (this.enableScripting && this.hasJSActions) {
                        r.addEventListener("updatefromsandbox", (n => {
                            const {detail: s} = n, a = {
                                value() {
                                    const a = r.options, i = s.value, o = new Set(Array.isArray(i) ? i : [i]);
                                    ...
                                    const a = r.options, i = s.remove;
                                    a[i].selected = !1;
                                    r.remove(i);
                                    if (a.length > 0) {
                                        -1 === Array.prototype.findIndex.call(a, (e => e.selected)) && (a[0].selected = !0)
                                    }
                                    e.setValue(t, {value: getValue(n, !0), items: getItems(n)})
                                }, clear() {
                                    for (; 0 !== r.length;) r.remove(0);
                                    e.setValue(t, {value: null, items: []})
                                }, insert() {
                                    const {index: a, displayValue: i, exportValue: o} = s.insert,
                                    ...
                                    const r = new Set(s.indices), a = n.target.options;
                                    Array.prototype.forEach.call(a, ((e, t) => {
                                        e.selected = r.has(t)
                                    }));
                                    e.setValue(t, {value: getValue(n, !0)})
                                }, focus() {
                                    setTimeout((() => n.target.focus({preventScroll: !1})), 0)
                                }, hidden() {
                        ...
                        r.addEventListener("input", (r => {
                            const n = getValue(r, !0), s = getValue(r, !1);
                        ...
                        this._setEventListeners(r, [["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"], ["input", "Action"]], (e => e.target.checked))
            ...
            class PopupAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    const r = new PopupElement({
                        ...
                        i = a[0] + this.data.parentRect[2] - this.data.parentRect[0], o = a[1];
            ...
            class PopupElement {
                ...
                render() {
                    ...
                    const r = this.color;
                    if (r) {
                        const e = .7 * (255 - r[0]) + r[0], n = .7 * (255 - r[1]) + r[1], a = .7 * (255 - r[2]) + r[2];
            ...
            const s = function renderTextLayerClosure() {
                const e = 30, t = new Map, r = /\S/;

                function appendText(s, a, i, o) {
                    const l = document.createElement("span"), c = {
                        angle: 0,
                        canvasWidth: 0,
                        isWhitespace: !1,
                    ...
                    const p = Math.hypot(h[2], h[3]), f = p * function getAscent(r, n) {
                        const s = t.get(r);
                        if (s) return s;
                        n.save();
                        n.font = `30px ${r}`;
                        const a = n.measureText("");
                        let i = a.fontBoundingBoxAscent, o = Math.abs(a.fontBoundingBoxDescent);
                        if (i) {
                            n.restore();
                            const e = i / (i + o);
                            t.set(r, e);
                        ...
                        i = 0;
                        for (let t = 0, r = l.length; t < r; t += 4) if (l[t] > 0) {
                    ...
                    let _ = !1;
                    if (a.str.length > 1) _ = !0; else if (a.transform[0] !== a.transform[3]) {
                        const e = Math.abs(a.transform[0]), t = Math.abs(a.transform[3]);
                    ...
                    if (s._enhanceTextSelection) {
                        ...
                        const r = (u.vertical ? a.height : a.width) * s._viewport.scale, i = p;
                        let o, c;
                        if (0 !== d) {
                            o = [e, t, -t, e, g, m];
                            c = n.Util.getAxialAlignedBoundingBox([0, 0, r, i], o)
                        } else c = [g, m, g + r, m + i];
                        s._bounds.push({left: c[0], top: c[1], right: c[2], bottom: c[3], div: l, size: [r, i], m: o})
                    }
                }
                ...
                function expand(e) {
                    ...
                    for (let r = 0; r < s.length; r++) {
                        const a = t[r].div, i = e._textDivProperties.get(a);
                        if (0 === i.angle) {
                ...
                TextLayerRenderTask.prototype = {
                    get promise() {
                        ...
                        if (this._textContent) {
                            const e = this._textContent.items, t = this._textContent.styles;
                        ...
                        for (let n = 0, s = this._textDivs.length; n < s; n++) {
                            const s = this._textDivs[n], a = this._textDivProperties.get(s);
            ...
            t.SVGGraphics = SVGGraphics;
            {
                const e = {fontStyle: "normal", fontWeight: "normal", fillColor: "#000000"},
                    r = "http://www.w3.org/XML/1998/namespace", i = "http://www.w3.org/1999/xlink",
                    o = ["butt", "round", "square"], l = ["miter", "round", "bevel"], c = function () {
                        ...
                        function encode(t, r, s, i) {
                            ...
                            const m = new Uint8Array([o >> 24 & 255, o >> 16 & 255, o >> 8 & 255, 255 & o, l >> 24 & 255, l >> 16 & 255, l >> 8 & 255, 255 & l, c, h, 0, 0, 0]),
                                ...
                                }(p), A = e.length + 36 + m.length + _.length, b = new Uint8Array(A);
                            let y = 0;
                            b.set(e, y);
                            y += e.length;
                ...
                t.SVGGraphics = SVGGraphics = class SVGGraphics {
                    ...
                    showText(t) {
                        const s = this.current, a = s.font, i = s.fontSize;
                        if (0 === i) return;
                        const o = s.fontSizeScale, l = s.charSpacing, c = s.wordSpacing, h = s.fontDirection,
                            d = s.textHScale * h, u = a.vertical, p = u ? 1 : -1, f = a.defaultVMetrics,
                            g = i * s.fontMatrix[0];
                        let m = 0;
                        for (const e of t) {
                            if (null === e) {
                    ...
                    shadingFill(e) {
                        const t = this.viewport.width, r = this.viewport.height,
                            s = n.Util.inverseTransform(this.transformMatrix), a = n.Util.applyTransform([0, 0], s),
                            i = n.Util.applyTransform([0, r], s), o = n.Util.applyTransform([t, 0], s),
                            l = n.Util.applyTransform([t, r], s), c = Math.min(a[0], i[0], o[0], l[0]),
                            h = Math.min(a[1], i[1], o[1], l[1]), d = Math.max(a[0], i[0], o[0], l[0]),
                            u = Math.max(a[1], i[1], o[1], l[1]), p = this.svgFactory.createElement("svg:rect");
                    ...
                    _makeTilingPattern(e) {
                        const t = e[1], r = e[2], s = e[3] || n.IDENTITY_MATRIX, [a, i, o, l] = e[4], c = e[5],
                            h = e[6], d = e[7],
                            p = "shading" + u++, [f, g] = n.Util.applyTransform([a, i], s), [m, _] = n.Util.applyTransform([o, l], s), [A, b] = n.Util.singularValueDecompose2dScale(s),
                            y = c * A, S = h * b, C = this.svgFactory.createElement("svg:pattern");
                        ...
                        const v = this.svg, x = this.transformMatrix, P = this.current.fillColor,
                            k = this.current.strokeColor, R = this.svgFactory.create(m - f, _ - g);
                        this.svg = R;
                    ...
                    constructPath(e, t) {
                        const r = this.current;
                        let s = r.x, a = r.y, i = [], o = 0;
                        for (const r of e) switch (0 | r) {
                            case n.OPS.rectangle:
                                s = t[o++];
                                a = t[o++];
                                const e = s + t[o++], r = a + t[o++];
                        ...
                        i = i.join(" ");
                        if (r.path && e.length > 0 && e[0] !== n.OPS.rectangle && e[0] !== n.OPS.moveTo) i = r.path.getAttributeNS(null, "d") + i; else {
            ...
            class XfaLayer {
                ...
                static render(e) {
                    const t = e.xfa, r = document.createElement(t.name);
                    t.attributes && XfaLayer.setAttributes(r, t.attributes);
                    const n = [[t, -1, r]], s = e.div;
                    s.appendChild(r);
            ...
            var n = r(2), s = r(24);
            const a = require("fs"), i = require("http"), o = require("https"), l = require("url"),
                c = /^file:\/\/\/[a-zA-Z]:\//;
        ...
        (() => {
            ...
            var t = __w_pdfjs_require__(1), r = __w_pdfjs_require__(5), n = __w_pdfjs_require__(2),
                s = __w_pdfjs_require__(18), a = __w_pdfjs_require__(9), i = __w_pdfjs_require__(12),
                o = __w_pdfjs_require__(20), l = __w_pdfjs_require__(21), c = __w_pdfjs_require__(22);
            {
