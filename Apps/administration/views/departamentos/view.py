...
# from Apps.administration.forms import DepartamentoForms, ConsultaForm
...
#                 data = [d.toList() for d in Departaments.objects.filter(pk=id)]
...
#         context['title_query'] = 'Seleccione el departamento a buscar'
