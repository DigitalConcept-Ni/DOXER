        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a title="Editar registro" href="/administration/subserie/edit/' + row.id + '/" type="button" class="btn btn-warning"><i class="fas fa-edit"></i></a>';
                    buttons += '<a title="Eliminar registro" href="/administration/subserie/delete/' + row.id + '/" type="button" class="btn btn-danger" style="margin: 0 5px 0 5px"><i class="fas fa-trash"></i></a>';
