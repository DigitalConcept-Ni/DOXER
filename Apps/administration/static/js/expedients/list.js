        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a title="Editar registro" href="/administracion/expedientes/edit/' + row.id + '/" type="button" class="btn btn-warning"><i class="fas fa-edit"></i></a>';
                    buttons += '<a title="Eliminar registro" href="/administracion/expedientes/delete/' + row.id + '/" type="button" class="btn btn-danger" style="margin: 0 5px 0 5px"><i class="fas fa-trash"></i></a>';
