...
from Apps.administration.views.documents.view import *
from Apps.administration.views.expedients.view import *
from Apps.administration.views.plantillas.view import *
from Apps.administration.views.departamentos.view import *
from Apps.administration.views.serie.view import *
from Apps.administration.views.sub_serial.view import *
...
urlpatterns = [
    ...
    path('documentType/edit/<int:pk>/', DocumentTypeUpdateview.as_view(), name='documents_type_edit'),
